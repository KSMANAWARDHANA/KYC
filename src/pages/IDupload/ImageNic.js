...
const NicFront=()=> {
  ...
  const {front,passport} = useParams();
  ...
  fetch(`http://192.168.1.12:8000/v1/users/files/${front}/${passport}/${user_id}`,{
        method: "PUT",
        headers: {
...
const NicBack=()=> {
 ...
 fetch(`http://192.168.1.12:8000/v1/users/files/${back}/${passport}/${user_id}`,{
       method: "PUT",
       headers: {
         authorization: `Bearer ${token}`,
       },
